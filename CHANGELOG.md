...
* add release-please manifest file to resolve config error ([bfd7f49](https://github.com/gmontupin/template-hexagonal-python/commit/bfd7f49d873a34e65fe582e42c98f3e339280d56))
* force tracking of release-please config files ([9e58fb4](https://github.com/gmontupin/template-hexagonal-python/commit/9e58fb499c0f9fe86deea8f7fe1664fe31753c9f))


### Tareas de Infraestructura

* finalize golden template infrastructure and release automation ([bb3544a](https://github.com/gmontupin/template-hexagonal-python/commit/bb3544ad5db8b4169a80292bec06a967224013f5))
* finalize project golden template structure ([ca43777](https://github.com/gmontupin/template-hexagonal-python/commit/ca43777c2c2ae9ea1aeb6b8583ee4c2a7cf82ca1))
* **master:** release template-hexagonal-python 0.1.1 ([be17be4](https://github.com/gmontupin/template-hexagonal-python/commit/be17be4a950f561b6a7fad06d5177459569d6f2c))
* **master:** release template-hexagonal-python 0.1.1 ([317b448](https://github.com/gmontupin/template-hexagonal-python/commit/317b448149be7e5c9c0b71c64e63fa112e6c43af))
* traducir secciones del changelog al español ([b2f9e08](https://github.com/gmontupin/template-hexagonal-python/commit/b2f9e08e0a42353eae3f05859450dc9439279919))

## [0.1.1](https://github.com/gmontupin/template-hexagonal-python/compare/template-hexagonal-python-v0.1.0...template-hexagonal-python-v0.1.1) (2026-03-15)
